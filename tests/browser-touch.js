...
async page => {
 ...
 await page.getByRole('tab',{name:'ㄅㄆㄇ 注音',exact:true}).click();await page.getByRole('button',{name:'練習 ㄅ',exact:true}).click();await page.getByRole('button',{name:'▶ 開始練習'}).click();
